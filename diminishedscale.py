# Program to generate the sounds of notes of a diminished scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a diminished scale
    notes_interval = [2, 1, 2, 1, 2, 1, 2, 1, 1] 
    rev_interval = [0, 1, 2, 1, 2, 1, 2, 1, 2]
    tones_fwd, tones_rev = [], []
    
    print(f'The frequencies in Hz of notes in the {notescale} diminished scale in ascending order')
    ...
    print()
    print(f'The frequencies in Hz of notes in the {notescale} diminished scale in descending order')
    ...
    # Return list of frequencies in the ascending and descending notes of the diminished scale    
...
def fmain(tones_fwd, tones_rev):
    ...
    # Sleep for 1 second before playing the notes of diminished scale in the descending order
    time.sleep(1)
...
# Scale list for which the diminished scale will be played in sequence
scale_list = ['C4']

#scale_list = ['Cs4', 'Gs4', 'Fs4', 'E4', 'Af3', 'C5']
